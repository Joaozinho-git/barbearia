...
| `_testar-indice.mjs` | **Teste de aceitação do índice lateral**, no navegador, em 6 viewports: clica em cada ponto, espera a rolagem suave terminar e confere qual acendeu. Cobre os cinco critérios (00 no topo, 04 no fim, clique coerente, sem andar para trás, todo ponto acende) e confere `aria-current` contra a classe. Rode depois de qualquer mexida no `SectionIndex` ou na altura de alguma seção. |
